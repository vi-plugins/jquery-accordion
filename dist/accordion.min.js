...
var Animation = (function (_super) {
    ...
    Animation.prototype.setActivePanel = function (index) {
    ...
    Animation.prototype.showPanel = function ($content, $panel) {
        ...
        $content.slideDown(this.options.openDuration, function () {
            $panel
                ...
                .trigger('after.open.panel.accordion', { panel: $panel, position: _this.getPanelPosition() });
            $content.removeAttr('style');
        });
    };
    Animation.prototype.getPanelPosition = function () {
        var opened = null;
