...
var Animation = (function (_super) {
    ...
    Animation.prototype.renderTabs = function () {
        ...
        this.$element.find('.accordion__titleLink').each(function (index, elem) {
            ...
            _this.$element.find('.accordion__tabsTitleLink').eq(index).append($(elem).text());
        });
    };
    ...
    Animation.prototype.fitIntoParent = function () {
        if (this.options.preventOverfulTabHeaders) {
            var contentWidth_1 = this.$element.innerWidth();
            var tabsWidth_1 = 0;
            var fits_1 = true;
            this.$element.find('.accordion__tabsPanel').each(function (index, elem) {
                tabsWidth_1 = tabsWidth_1 + $(elem).outerWidth();
                if (tabsWidth_1 >= contentWidth_1) {
                    fits_1 = false;
                    return false;
                }
            });
